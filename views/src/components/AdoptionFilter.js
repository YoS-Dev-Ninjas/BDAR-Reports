...
export default function AdoptionFilter() {
 ...
 try {
 const response = await fetch(`${process.env.REACT_APP_API_URL}/AdoptionDataGrid`);
...
{ field: 'sex_id', headerName: 'Gender', width: 200 },
{ field: 'date_of_birth', headerName: 'Date-Of-Birth', width: 200 },
{ field: 'occupation', headerName: 'occupation', width: 200 },
{ field: 'nationality_id', headerName: 'Nationality', width: 200 },
{ field: 'primary_phone_number', headerName: 'PhoneNumber', width: 200 },
{ field: 'court_adoption_order_date_of_issue', headerName: 'Court Order Issue Date', width: 200 },
{ field: 'court_adoption_order_number', headerName: 'Court Order Number', width: 200 },
{ field: 'date_of_adoption', headerName: 'Adoption-Date', width: 200 },
...
{ field: 'birth_certificate_number', headerName: 'Birth-Certificate-Number', width: 300 },
{ field: 'court_guardianship_order_date_of_issue', headerName: 'Guardianship-Court-Order Issue-Date', width: 200 },
{ field: 'court_guardianship_order_number', headerName: 'Guardianship-Court-Order Number', width: 200 },
{ field: 'date_of_guardianship', headerName: 'Date of Guardianship', width: 300 },
{ field: 'end_date_of_guardianship', headerName: 'Guardianship End-Date', width: 200 },
{ field: 'latency_reason', headerName: 'Latency Reason', width: 200 },
];
return (
    <div>
...
<MenuA />
 ...
 {/* Sidebar */}
  <div className="main-panel">
    ...
    <h4 className="page-title">Filter Adoption Record(s) :</h4>
  </div>
  <div className="row">
