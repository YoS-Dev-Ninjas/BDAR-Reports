...
export default function BirthFilter() {

 //Load Data
 const [Configs, setConfig] = useState([]);
 const ShowConfigs = async() => {
 try {
 const response = await fetch(`${process.env.REACT_APP_API_URL}/BirthDataGrid`);
...
{ field: 'time_of_birth', headerName: 'Time-Of-Birth', width: 200 },
{ field: 'weight_on_birth', headerName: 'Weight-At-Birth', width: 100 },
{ field: 'place_of_birth', headerName: 'Birth-Place', width: 200 },
...
{ field: 'order_certificate', headerName: 'Ordered-Certificate', width: 200 },
];
...
<MenuA />
 ...
 {/* Sidebar */}
  <div className="main-panel">
    ...
    <h4 className="page-title">Filter Birth Record(s) :</h4>
  </div>
  <div className="row">
